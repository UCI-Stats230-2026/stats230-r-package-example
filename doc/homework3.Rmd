---
title: "Homework 3: Optimization Methods for Logistic Regression"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Homework 3: Optimization Methods for Logistic Regression}
...
First fitting the models, then plotting the coefficients and confidence intervals.
```{r packages}
library(STATS230)
library(ggplot2)
library(bench)
